...
with open('chi_squared.csv', mode='w') as csv_file:
    fieldnames = ['Wort', 'DDR', 'BRD', 'chi squared', 'signifikant']
    ...
    for w in mfw_ddr:
        ...
        if w in mfw_brd:
            ...
            row = {'Wort': w, 'DDR': obs_x_ddr, 'BRD': obs_x_brd, 'chi squared': chi_squared, 'signifikant': sig}
            writer.writerow(row)
